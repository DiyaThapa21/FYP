...
<div class="card shadow mb-4">
  ...
  <div class="card-header py-3">
    ...
    @can('manage-blog-tag')<a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right"
      ...
      <table class="table table-bordered" id="post-category-dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              @can('manage-blog-tag')<a href="{{route('post-tag.edit',$data->id)}}"
                class="btn btn-primary btn-sm float-left mr-1"
                style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit"
                data-placement="bottom"><i class="fas fa-edit"></i></a>@endcan
              @can('manage-blog-tag')<form method="POST" action="{{route('post-tag.destroy',[$data->id])}}">
                @csrf
                @method('delete')
