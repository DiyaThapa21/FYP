...
@section('title','Un-ko Uneko || HOME PAGE')
                        ...
                        <div class="single-list">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        <h4 class="title"><a href="">{{$product->title}}</a>
                                        </h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="shop-single-blog">
                    <img src="{{ asset($post->photo) }}" alt="{{ asset($post->photo) }}" style="height: 250px; object-fit:cover; width:100px;">
                    <div class="content">
