...
@section('title','Unko-Uneko || Product Filter Page')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="single-widget recent-post">
                    <h3 class="title">Recent Product</h3>
                    {{-- {{dd($recent_products)}} --}}
                    ...
                    <div class="single-post first">
                        <div class="image">
                            <img src="{{ asset($product->photo) }}" alt="{{$photo[0]}}">
                        </div>
                        <div class="content">
                            ...
                            @endphp
                            <p class="price"><del class="text-muted">Rs{{number_format($product->price,2)}}</del>
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{route('product-detail',$product->slug)}}">
                                        ...
                                        $photo=explode(',',$product->photo);
                                        @endphp
                                        <img class="default-img" src="{{ asset($product->photo) }}" alt="{{$photo[0]}}">
                                        <img class="hover-img" src="{{ asset($product->photo) }}" alt="{{$photo[0]}}">
                                    </a>
                        ...
                        <div class="product-gallery">
                            <div class="quickview-slider-active">
                                ...
                                <div class="single-slider">
                                    <img src="{{ asset($product->photo) }}" alt="{{$data}}">
                                </div>
                                @endforeach
                            </div>
                        </div>
